...
import com.petrol.station.exception.ElementParseException;
...
import static com.petrol.station.model.enums.BrandType.WOG;
import static java.util.stream.Collectors.toList;

@Log4j
@Component
public class WogParser extends PetrolStationParser<Element> {
    ...
    private String petrolStationListUrl;
    ...
    @Override
    protected List<Element> getOriginalPetrolStations() throws IOException {
        Document domHtml = Jsoup.parse(new URL(petrolStationListUrl), timeOut);
